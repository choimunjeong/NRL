...
public class Page2 extends AppCompatActivity implements Page2_OnItemClick  ,  SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private void settingAPI_Data() {
        ...
        try {
            ...
            for (int i = 0; i < item.length(); i++) {
                ...
                sigungucode_arr = jObject.getString("sigungucode");
                name = jObject.getString("title");
                tourList.add(name);
                cardview_items.add(new Recycler_item(img_Url, name, contentid, subject, areacode, sigungucode_arr));
            }
    ...
    class SearchTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            try {
                url = new URL("http://api.visitkorea.or.kr/openapi/service/rest/KorService/areaBasedList?serviceKey=" +
