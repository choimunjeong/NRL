...
public class Page1_Main extends AppCompatActivity implements   Page1_pagerAdapter.send_expand, Page1_Position, SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(!db_key.equals(check_SecondPage) && today <= ddayend){
            setSecondMain();
        }
    ...
    public void onClick_startBtn() {
        ...
        if(!checkLocationServicesStatus()) {
            ...
            requestPermissions();
            Toast.makeText(getApplicationContext(), "여행시작 버튼을 한번 더 눌러주세요.", Toast.LENGTH_LONG).show();
        } else {
    ...
    public void setSecondMain() {
        ...
        builder.setPositiveButton("확인", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                second_mainDBHelper.insertColumn(db_key, d_day, endDate);
